...
<div class="admin_formulario">
   ...
   <div class="input_form">
     <input type="text" id="txtUAUsuario" name="txtUAUsuario"/>
    </div>
    ...
    <div class="input_form">
     <input type="text" id="txtUACargo" name="txtUACargo"/>
    </div>
    ...
    <div class="input_form">
     <select id="sltUANivel" name="sltUANivel">
      <option>1 </option>
      <option>2 </option>
      <option>3 </option>
      <option>4 </option>
   ...
   <input type="button" id="btnUAGuardar" name="btnUAGuardar" value="Guardar" onclick="javascript:umodifica2()"/>
    </div><!--tittle-->
    <div class="button_form">
