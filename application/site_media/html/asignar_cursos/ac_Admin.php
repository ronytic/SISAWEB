...
<link rel="stylesheet" type="text/css" href="../../site_media/css/jquery.dataTables.css">
    ...
    <script type="text/javascript" language="javascript" src="../../site_media/js/AC_Admin.js"></script>
	<script type="text/javascript" language="javascript" src="../../site_media/js/jquery.dataTables.js"></script>
<script>javascript:adminasicur('../../site_media/html/asignar_cursos/ac_table.php')</script>
</head>
<body>
<div class="content_body">
    <div class="head_admin">
        <div class="tittle_admin">
            <img src="../../site_media/img/asignar_cursos.png" width="30px" height="30px"/>
            <span class="name_admin">ADMINISTRA ASIGNACION DE CURSOS</span>
        </div><!--tittle_admin-->
        <div class="icon_admin">
        	<a href="javascript:asigcuradi" > 
            <div class="iconA">
                <img src="../../site_media/img/user_add.jpg" width="20px" height="20px"/>
                <span class="letter_icon">Adiciona</span>
            </div><!--iconA-->
        	</a>
            <a href="javascript:umodifica('../../site_media/html/asignar_cursos/ac_modifica.php')" > 
            <div class="iconA">
                <img src="../../site_media/img/user_edit.jpg" width="20px" height="20px"/>
                <span class="letter_icon">Modifica</span>
            </div><!--iconA-->
            </a>
            <a href="javascript:uelimina('../../site_media/html/asignar_cursos/ac_elimina.php')" > 
            <div class="iconA">
              <img src="../../site_media/img/user_delete.jpg" width="20px" height="20px"/>
                <span class="letter_icon">Elimina</span>
            </div><!--iconA-->
            </a> 
            <a href="javascript:adminusu('../../site_media/html/asignar_cursos/ac_table.php')" > 
            <div class="iconA">
